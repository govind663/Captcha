                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="input-block mb-3">
                                                ...
                                                <input type="text" readonly id="package_amt" name="package_amt" class="form-control @error('package_amt') is-invalid @enderror" value="{{ old('package_amt') }}" placeholder="Enter Package Amount">
                                                <input type="text" hidden id="captcha_type_id" name="captcha_type_id" class="form-control" value="{{ old('captcha_type_id') }}">
                                                @error('package_amt')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
