                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <select  class="form-control @error('captcha_type_id') is-invalid @enderror select2" id="captcha_type_id" name="captcha_type_id">
                                                ...
                                                <option value="{{ $value->id }}" {{ ($package->captcha_type_id == $value->id ? "selected":"") }}>{{ $value->type_name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="input-block mt-3 mb-3">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                @if(!empty($package->image))
                                                    <a href="{{ url('/') }}/captcha/package/image/{{ $package->image }}" target="_blank" class="btn btn-primary btn-sm">
                                                        <b> View Document</b>
                                                    </a>
                                                @endif
                                            </div>
