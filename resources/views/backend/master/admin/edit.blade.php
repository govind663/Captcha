                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $employee->email }}" placeholder="Enter Email Id">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="form-group mb-3" >
                                            ...
                                            <select class="form-control @error('user_type') is-invalid @enderror select2" id="user_type" name="user_type">
                                                ...
                                                {{-- <option value="1" {{ ($employee->user_type == '1' ? "selected":"") }}>Super Admin</option> --}}
                                                <option value="2" {{ ($employee->user_type == '2' ? "selected":"") }}>Admin</option>
                                            </select>
                                            @error('user_type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
